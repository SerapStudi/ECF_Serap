<?php 
    session_start();
    require_once '10_config.php'; // ajout connexion bdd 
   // si la session existe pas soit si l'on est pas connecté on redirige
    ...
    $req = $bdd->prepare('SELECT * FROM utilisateurs WHERE acces = ?');
        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <div class="text-center">
                        <h1 class="p-5">Bonjour <?php echo $data['nom']; ?> !</h1>
                        <hr />
                        <a href="10_deconnexion.php" class="btn btn-danger btn-lg">Déconnexion</a>
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Changer mon mot de passe</h5>
                            ...
                            <div class="modal-body">
                                <form action="10_change_password.php" method="POST">
            ...
            <div class="modal fade" id="avatar" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="10_change_avatar.php" method="POST" enctype="multipart/form-data">
